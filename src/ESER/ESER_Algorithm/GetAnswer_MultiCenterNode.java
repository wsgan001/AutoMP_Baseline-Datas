...
public class GetAnswer_MultiCenterNode {
	...
	public static Set<Integer> CandidateCenters = new HashSet<Integer>();
	public static Map<Integer, Integer> VisitNum = new HashMap<Integer, Integer>();
	
	public static Vector<SatiPath> SP = new Vector<SatiPath>();
	public static Vector<SatiPath> tmpSP = new Vector<SatiPath>();
	
	public static Map<String, HashSet<Integer>> SamePath = new HashMap<String, HashSet<Integer>>();
	public static Map<Integer, HashSet<Integer>> Center2OneStep = new HashMap<Integer, HashSet<Integer>>();
	public static ArrayList<Integer> Tmplb2SPlb = new ArrayList<Integer>();
	
	//public static Map<String, List<Integer>> Hash2Path = new HashMap<String, List<Integer>>();
	public static Map<String, Integer> Path = new HashMap<String, Integer>();
	public static Integer PathCnt = 0;
	
	public static Map<Integer, Double> ResultScore = new HashMap<Integer, Double>();
	...
	public static Boolean addVisitNum(Integer x, Integer lim)
	{
	...
	public static void BFSFindCenter(Integer now)
	{
        ...
        {
            Integer x = q.poll();
            //if(CenterNode == 630840) System.out.println(x);
            Integer d = dis.get(x);
            if(addVisitNum(x, SampleNodes.size() - RelaxNumber))CandidateCenters.add(x);
            if( !g.G.containsKey(x) || d>=LimS ) continue;
            HashMap<Integer, List<Integer>> outedges = g.G.get(now);
	...
	private static String listIntegerHash(ArrayList<Integer> v)
	{
	...
	private static String pathIntegerHash(ArrayList<Integer> v)
	{
		BigInteger sum = BigInteger.valueOf(0);
		BigInteger add = BigInteger.valueOf(1);
		BigInteger mul = BigInteger.valueOf(10000000);
	...
	private static void DFS_Path(Integer ct, Integer node, Integer le, ArrayList<Integer> walkedges)
	{
		...
		for(Map.Entry<Integer, List<Integer>> KV : outedges.entrySet())
		{
			...
			if(len == 1)//Record OneStep to CenterNode
			{
	...
	private static double setCap(SatiPath s1, SatiPath s2)
	{
		Integer cnt = 0;
